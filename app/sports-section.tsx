  ...
  return (
    <section className='bg-gray-900 py-6'>
      ...
      <div className='mb-4 flex items-center justify-between px-4'>
        <h2 className='text-lg font-semibold text-gray-200'>Sports</h2>
        <a
          href='#!'
            ...
            <a key={sport.name} href='#!' className='group w-35 shrink-0 sm:w-40'>
              ...
              <div className='relative aspect-square overflow-hidden rounded-xl bg-gray-700'>
                ...
                <div className='absolute inset-0 flex items-center justify-center'>
                  <div className='h-12 w-12 rounded-lg bg-gray-500/40' />
                </div>
                ...
                {/* Sport Name */}
                <div className='absolute right-0 bottom-0 left-0 bg-linear-to-t from-gray-900/80 to-transparent p-3'>
                  <span className='text-sm font-medium text-gray-200'>{sport.name}</span>
                </div>
              </div>
            </a>
          ))}
